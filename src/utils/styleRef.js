...
export const SDK_VARIABLE_DEFAULTS = {
  ...
  [SDK_VARIABLES.accent]:        '#14a1c5',
  [SDK_VARIABLES.accentHover]:   '#108ba8',
  [SDK_VARIABLES.accentGlow]:    'rgba(20,161,197,0.35)',
  [SDK_VARIABLES.accentSubtle]:  'rgba(20,161,197,0.12)',
